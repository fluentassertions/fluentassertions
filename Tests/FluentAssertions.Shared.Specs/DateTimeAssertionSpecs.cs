...
namespace FluentAssertions.Specs
{
	...
	public class DateTimeAssertionSpecs
	{
		...
		{
			DateTimeAssertions assertions = new DateTime(2016, 06, 04).Should();
			assertions.Invoking(x => x.BeOnOrAfter(new DateTime(2016, 06, 05), "because we want to test the failure {0}", "message"))
				.ShouldThrow<AssertFailedException>()
				.WithMessage(string.Format(
					"Expected a date and time on or after <{0}> because we want to test the failure message, but found <{1}>.",
					new DateTime(2016, 06, 05).ToString("yyyy-MM-dd"), new DateTime(2016, 06, 04).ToString("yyyy-MM-dd")));
		}
		#endregion
