...
namespace FluentAssertions.Specs
{
    ...
    public class DateTimeOffsetAssertionSpecs
    {
        ...
        public void When_a_value_is_not_one_of_the_specified_values_it_should_throw()
        {
            ...
            // Arrange
            //-----------------------------------------------------------------------------------------------------------
            DateTimeOffset value = new DateTime(2016, 12, 30, 23, 58, 57);
            ...
            //-----------------------------------------------------------------------------------------------------------
            action.ShouldThrow<AssertFailedException>()
                .WithMessage("Expected value to be one of {<2016-12-31 23:58:57 +1h>, <2016-12-30 23:58:57.001 +1h>}, but found <2016-12-30 23:58:57 +1h>.");
        }
        ...
        public void When_a_value_is_not_one_of_the_specified_values_it_should_throw_with_descriptive_message()
        {
            ...
            //-----------------------------------------------------------------------------------------------------------
            action.ShouldThrow<AssertFailedException>()
                .WithMessage("Expected value to be one of {<2016-12-31 23:58:57 +1h>, <2016-12-30 23:58:57.001 +1h>} because it's true, but found <2016-12-30 23:58:57 +1h>.");
        }
        ...
        public void When_a_null_value_is_not_one_of_the_specified_values_it_should_throw()
        {
            ...
            // Act
            //-----------------------------------------------------------------------------------------------------------
            Action action = () => value.Should().BeOneOf(new DateTime(2216, 1, 30, 0, 5, 7), new DateTime(2016, 2, 10, 2, 45, 7));

            //-----------------------------------------------------------------------------------------------------------
            // Assert
            //-----------------------------------------------------------------------------------------------------------
            action.ShouldThrow<AssertFailedException>()
                .WithMessage("Expected value to be one of {<2216-01-30 00:05:07 +1h>, <2016-02-10 02:45:07 +1h>}, but found <null>.");
        }
