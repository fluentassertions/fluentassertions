...
{
    public class GenericReadOnlyDictionaryAssertionSpecs
    {
        ...
        public void When_the_same_dictionaries_are_expected_to_be_the_same_it_should_not_fail()
        {
            ...
            IReadOnlyDictionary<int, string> referenceToDictionary = dictionary;
        ...
        public void When_dictionary_is_expected_to_be_null_and_it_is_it_should_not_throw()
        {
            ...
            // Arrange
            //-----------------------------------------------------------------------------------------------------------
            IReadOnlyDictionary<int, string> someDictionary = null;
        ...
        public void When_a_custom_dictionary_implementation_is_expected_not_to_be_null_and_it_is_it_should_not_throw()
        {
            ...
            // Arrange
            //-----------------------------------------------------------------------------------------------------------
            IReadOnlyDictionary<int, string> dictionary = new TrackingReadOnlyTestDictionary();
        ...
        public void When_dictionary_is_not_expected_to_be_null_and_it_isnt_it_should_not_throw()
        {
            ...
            // Arrange
            //-----------------------------------------------------------------------------------------------------------
            IReadOnlyDictionary<int, string> someDictionary = new Dictionary<int, string>();
        ...
        public void When_asserting_dictionary_with_items_is_not_empty_it_should_enumerate_the_dictionary_only_once()
        {
            ...
            // Arrange
            //-----------------------------------------------------------------------------------------------------------
            var trackingDictionary = new TrackingReadOnlyTestDictionary(new KeyValuePair<int, string>(1, "One"));
        ...
        public void Should_succeed_when_asserting_dictionary_is_equal_to_the_same_dictionary()
        {
            ...
            // Arrange
            //-----------------------------------------------------------------------------------------------------------
            IReadOnlyDictionary<int, string> dictionary1 = new Dictionary<int, string>
            {
                [1] = "One",
                [2] = "Two"
            };
            IReadOnlyDictionary<int, string> dictionary2 = new Dictionary<int, string>
            {
                [1] = "One",
                [2] = "Two"
            };
        ...
        public void When_asserting_dictionaries_to_be_equal_but_subject_dictionary_is_null_it_should_throw()
        {
            ...
            // Arrange
            //-----------------------------------------------------------------------------------------------------------
            IReadOnlyDictionary<int, string> dictionary1 = null;
            IReadOnlyDictionary<int, string> dictionary2 = new Dictionary<int, string>
            {
                [1] = "One",
                [2] = "Two"
        ...
        public void When_asserting_dictionaries_not_to_be_equal_subject_but_both_dictionaries_reference_the_same_object_it_should_throw()
        {
            ...
            IReadOnlyDictionary<int, string> dictionary2 = dictionary1;
        ...
        public void When_a_dictionary_has_custom_equality_comparer_the_contains_key_assertion_should_work_accordingly()
        {
            ...
            // Arrange
            //-----------------------------------------------------------------------------------------------------------
            IReadOnlyDictionary<string, string> dictionary = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ["One"] = "One",
                ["Two"] = "Two"
            };
        ...
        public void When_the_requested_key_exists_it_should_allow_continuation_with_the_value()
        {
            ...
            // Arrange
            //-----------------------------------------------------------------------------------------------------------
            IReadOnlyDictionary<string, MyClass> dictionary = new Dictionary<string, MyClass>
            {
        ...
        public void When_the_specified_value_exists_it_should_allow_continuation_using_that_value()
        {
            ...
            IReadOnlyDictionary<int, MyClass> dictionary = new Dictionary<int, MyClass>
            {
                [1] = myClass
            };
    ...
    internal class TrackingReadOnlyTestDictionary : IReadOnlyDictionary<int, string>
    {
        private readonly IReadOnlyDictionary<int, string> entries;

        public TrackingReadOnlyTestDictionary(params KeyValuePair<int, string>[] entries)
        {
