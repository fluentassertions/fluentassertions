...
namespace FluentAssertions.Specs
{
    ...
    public class DateTimeAssertionSpecs
    {
        ...
        public void When_asserting_subject_null_datetime_should_have_year_should_throw()
        {
            ...
            // Assert
            //-----------------------------------------------------------------------------------------------------------
            act.ShouldThrow<XunitException>().WithMessage("Expected year to be 2008, but found a <null> DateTime.");
        }
        ...
        public void When_asserting_subject_null_datetime_should_not_have_year_should_throw()
        {
            ...
            // Assert
            //-----------------------------------------------------------------------------------------------------------
            act.ShouldThrow<XunitException>().WithMessage("Expected year not to be 2008, but found a <null> DateTime.");
        }
        #endregion
        ...
        public void When_asserting_subject_null_datetime_should_have_month_should_throw()
        {
            ...
            // Assert
            //-----------------------------------------------------------------------------------------------------------
            act.ShouldThrow<XunitException>().WithMessage("Expected month to be 12, but found a <null> DateTime.");
        }
        ...
        public void When_asserting_subject_null_datetime_should_not_have_month_should_throw()
        {
            ...
            // Assert
            //-----------------------------------------------------------------------------------------------------------
            act.ShouldThrow<XunitException>().WithMessage("Expected month not to be 12, but found a <null> DateTime.");
        }
        #endregion
        ...
        public void When_asserting_subject_null_datetime_should_have_day_should_throw()
        {
            ...
            // Assert
            //-----------------------------------------------------------------------------------------------------------
            act.ShouldThrow<XunitException>().WithMessage("Expected day to be 22, but found a <null> DateTime.");
        }
        ...
        public void When_asserting_subject_null_datetime_should_not_have_day_should_throw()
        {
            ...
            // Assert
            //-----------------------------------------------------------------------------------------------------------
            act.ShouldThrow<XunitException>().WithMessage("Expected day not to be 22, but found a <null> DateTime.");
        }
        #endregion
        ...
        public void When_asserting_subject_null_datetime_should_have_hour_should_throw()
        {
            ...
            // Assert
            //-----------------------------------------------------------------------------------------------------------
            act.ShouldThrow<XunitException>().WithMessage("Expected hour to be 22, but found a <null> DateTime.");
        }
        ...
        public void When_asserting_subject_null_datetime_should_not_have_hour_should_throw()
        {
            ...
            // Assert
            //-----------------------------------------------------------------------------------------------------------
            act.ShouldThrow<XunitException>().WithMessage("Expected hour not to be 22, but found a <null> DateTime.");
        }
        #endregion
        ...
        public void When_asserting_subject_null_datetime_should_have_minute_should_throw()
        {
            ...
            // Assert
            //-----------------------------------------------------------------------------------------------------------
            act.ShouldThrow<XunitException>().WithMessage("Expected minute to be 22, but found a <null> DateTime.");
        }
        ...
        public void When_asserting_subject_null_datetime_should_not_have_minute_should_throw()
        {
            ...
            // Assert
            //-----------------------------------------------------------------------------------------------------------
            act.ShouldThrow<XunitException>().WithMessage("Expected minute not to be 22, but found a <null> DateTime.");
        }
        #endregion
        ...
        public void When_asserting_subject_null_datetime_should_have_second_should_throw()
        {
            ...
            // Assert
            //-----------------------------------------------------------------------------------------------------------
            act.ShouldThrow<XunitException>().WithMessage("Expected second to be 22, but found a <null> DateTime.");
        }
        ...
        public void When_asserting_subject_null_datetime_should_not_have_second_should_throw()
        {
            ...
            // Assert
            //-----------------------------------------------------------------------------------------------------------
            act.ShouldThrow<XunitException>().WithMessage("Expected second not to be 22, but found a <null> DateTime.");
        }
        #endregion
        ...
        public void When_asserting_subject_datetime_represents_a_different_kind_it_should_throw()
        {
            ...
            // Assert
            //-----------------------------------------------------------------------------------------------------------
            act.ShouldThrow<XunitException>().WithMessage("Expected kind to be Utc, but found Local.");
        }
        ...
        public void When_asserting_subject_null_datetime_represents_a_specific_kind_it_should_throw()
        {
            ...
            // Assert
            //-----------------------------------------------------------------------------------------------------------
            act.ShouldThrow<XunitException>().WithMessage("Expected kind to be Utc, but found a <null> DateTime.");
        }
        #endregion
