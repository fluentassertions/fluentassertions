...
public partial class AsyncEnumerableAssertionSpecs
{
    public class BeNull
    {
        ...
        {
            // Arrange
            IAsyncEnumerable<string> someCollection = null;
        ...
        {
            // Arrange
            IAsyncEnumerable<string> someCollection = new string[0].ToAsyncEnumerable();
    ...
    public class NotBeNull
    {
        ...
        public void When_collection_is_not_expected_to_be_null_and_it_isnt_it_should_not_throw()
        {
            ...
            // Act / Assert
            someCollection.ToAsyncEnumerable().Should().NotBeNull();
        }
