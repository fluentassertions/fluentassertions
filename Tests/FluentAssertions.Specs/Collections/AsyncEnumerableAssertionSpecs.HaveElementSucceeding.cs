...
public partial class AsyncEnumerableAssertionSpecs
{
    public class HaveElementSucceeding
    {
        ...
        public void When_collection_has_the_correct_element_succeeding_another_it_should_not_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().HaveElementSucceeding("cris", "mick");
        ...
        public void When_collection_has_the_wrong_element_succeeding_another_it_should_not_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().HaveElementSucceeding("mick", "cris", "because of some reason");
        ...
        public void When_nothing_is_succeeding_an_element_it_should_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().HaveElementSucceeding("john", "jane");
        ...
        public void When_expecting_an_element_to_succeed_another_but_the_collection_is_empty_it_should_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().HaveElementSucceeding("mick", "cris");
        ...
        public void When_a_null_element_is_succeeding_another_element_it_should_not_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().HaveElementSucceeding("mick", null);
        ...
        public void When_an_element_is_succeeding_a_null_element_it_should_not_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().HaveElementSucceeding(null, "john");
        ...
        public void When_an_element_is_not_succeeding_a_null_element_it_should_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().HaveElementSucceeding(null, "cris");
        ...
        {
            // Arrange
            IAsyncEnumerable<string> collection = null;
