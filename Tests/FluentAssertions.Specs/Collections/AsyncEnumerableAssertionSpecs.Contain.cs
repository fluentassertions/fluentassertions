...
public partial class AsyncEnumerableAssertionSpecs
{
    public class Contain
    {
        ...
        public void Should_succeed_when_asserting_collection_contains_an_item_from_the_collection()
        {
            ...
            // Act / Assert
            collection.ToAsyncEnumerable().Should().Contain(1);
        }
        ...
        public void Should_succeed_when_asserting_collection_contains_multiple_items_from_the_collection_in_any_order()
        {
            ...
            // Act / Assert
            collection.ToAsyncEnumerable().Should().Contain([2, 1]);
        }
        ...
        {
            // Arrange
            IEnumerable<string> array = ["string1", "string2", "string3"];
            var strings = array.ToAsyncEnumerable();
        ...
        {
            // Arrange
            const IAsyncEnumerable<string> strings = null;
        ...
        public void When_the_multiple_matching_objects_exists_it_continuation_using_the_matched_value_should_fail()
        {
            ...
            IEnumerable<DateTime> array = [now, DateTime.SpecifyKind(now, DateTimeKind.Unspecified)];
            var collection = array.ToAsyncEnumerable();
    ...
    public class NotContain
    {
        ...
        {
            // Arrange
            var array = new OneTimeEnumerable<int>(1, 2, 3);
            var collection = array.ToAsyncEnumerable();
