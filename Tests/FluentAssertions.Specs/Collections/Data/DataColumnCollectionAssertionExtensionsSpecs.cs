...
namespace FluentAssertions.Specs.Collections.Data
{
    public static class DataColumnCollectionAssertionExtensionsSpecs
    {
        ...
        public class HaveSameCount
        {
            ...
            [Fact]
            public void When_two_DataColumnCollections_have_the_same_number_of_columns_it_should_succeed()
            {
                // Arrange
            ...
            [Fact]
            public void When_two_DataColumnCollections_do_not_have_the_same_number_of_columns_it_should_fail()
            {
                // Arrange
                var firstDataTable = new DataTable();
                var secondDataTable = new DataTable();
            ...
            [Fact]
            public void When_generic_collection_is_compared_with_DataColumnCollection_with_same_number_of_columns_it_should_succeed()
            {
                // Arrange
                var firstDataTable = new DataTable();
                var secondDataTable = new DataTable();
            ...
            [Fact]
            public void When_generic_collection_is_compared_with_DataColumnCollection_with_different_number_of_columns_it_should_fail()
            {
                // Arrange
                var firstDataTable = new DataTable();
                var secondDataTable = new DataTable();
        ...
        public class NotHaveSameCount
        {
            ...
            [Fact]
            public void When_two_DataColumnCollections_have_different_number_of_columns_it_should_succeed()
            {
                // Arrange
                var firstDataTable = new DataTable();
                var secondDataTable = new DataTable();
            ...
            [Fact]
            public void When_two_DataColumnCollections_have_the_same_number_of_columns_it_should_fail()
            {
                // Arrange
                var firstDataTable = new DataTable();
                var secondDataTable = new DataTable();
            ...
            [Fact]
            public void When_generic_collection_is_compared_with_DataColumnCollection_with_same_number_of_columns_it_should_fail()
            {
                // Arrange
                var firstDataTable = new DataTable();
                var secondDataTable = new DataTable();
            ...
            [Fact]
            public void When_generic_collection_is_compared_with_DataColumnCollection_with_different_number_of_columns_it_should_succeed()
            {
                // Arrange
                var firstDataTable = new DataTable();
                var secondDataTable = new DataTable();
