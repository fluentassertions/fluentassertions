...
public partial class AsyncEnumerableAssertionSpecs
{
    public class AllSatisfy
    {
        ...
        public void A_null_inspector_should_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().AllSatisfy(null);
        ...
        public void An_empty_collection_should_succeed()
        {
            ...
            // Act / Assert
            collection.ToAsyncEnumerable().Should().AllSatisfy(x => x.Should().Be(1));
        }
        ...
        public void All_items_satisfying_inspector_should_succeed()
        {
            ...
            // Act / Assert
            collection.ToAsyncEnumerable().Should().AllSatisfy(x => x.Age.Should().Be(21));
        }
