...
public partial class AsyncEnumerableAssertionSpecs
{
    public class AllBeAssignableTo
    {
        ...
        public void When_the_types_in_a_collection_is_matched_against_a_null_type_it_should_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().AllBeAssignableTo(null);
        ...
        public void All_items_in_an_empty_collection_are_assignable_to_a_generic_type()
        {
            ...
            // Act / Assert
            collection.ToAsyncEnumerable().Should().AllBeAssignableTo<int>();
        }
        ...
        public void All_items_in_an_empty_collection_are_assignable_to_a_type()
        {
            ...
            // Act / Assert
            collection.ToAsyncEnumerable().Should().AllBeAssignableTo(typeof(int));
        }
        ...
        public void When_all_of_the_types_in_a_collection_match_the_type_or_subtype_it_should_succeed()
        {
            ...
            // Act / Assert
            collection.ToAsyncEnumerable().Should().AllBeAssignableTo<Exception>();
        }
        ...
        public void When_one_of_the_types_does_not_match_it_should_throw_with_a_clear_explanation()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().AllBeAssignableTo(typeof(int), "because they are of different type");
        ...
        public void When_one_of_the_types_does_not_match_the_generic_type_it_should_throw_with_a_clear_explanation()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().AllBeAssignableTo<int>("because they are of different type");
