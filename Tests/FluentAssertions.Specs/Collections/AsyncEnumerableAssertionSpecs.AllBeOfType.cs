...
public partial class AsyncEnumerableAssertionSpecs
{
    public class AllBeOfType
    {
        ...
        public void When_the_types_in_a_collection_is_matched_against_a_null_type_exactly_it_should_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().AllBeOfType(null);
        ...
        public void All_items_in_an_empty_collection_are_of_a_generic_type()
        {
            ...
            // Act / Assert
            collection.ToAsyncEnumerable().Should().AllBeOfType<int>();
        }
        ...
        public void All_items_in_an_empty_collection_are_of_a_type()
        {
            ...
            // Act / Assert
            collection.ToAsyncEnumerable().Should().AllBeOfType(typeof(int));
        }
        ...
        {
            // Arrange
            IAsyncEnumerable<object> collection = null;
        ...
        public void When_one_of_the_types_does_not_match_exactly_it_should_throw_with_a_clear_explanation()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().AllBeOfType(typeof(Exception), "because they are of different type");
        ...
        public void When_one_of_the_types_does_not_match_exactly_the_generic_type_it_should_throw_with_a_clear_explanation()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().AllBeOfType<Exception>("because they are of different type");
        ...
        public void When_one_of_the_elements_is_null_for_an_exact_match_it_should_throw_with_a_clear_explanation()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().AllBeOfType<int>("because they are of different type");
        ...
        public void When_collection_of_types_and_objects_match_type_exactly_it_should_succeed()
        {
            ...
            // Act / Assert
            collection.ToAsyncEnumerable().Should().AllBeOfType<ArgumentException>();
        }
        ...
        public void When_collection_of_types_and_objects_do_not_match_type_exactly_it_should_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().AllBeOfType<ArgumentException>();
