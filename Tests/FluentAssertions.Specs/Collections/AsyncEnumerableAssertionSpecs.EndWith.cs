...
public partial class AsyncEnumerableAssertionSpecs
{
    public class EndWith
    {
        ...
        {
            // Arrange
            string[] array = ["john", "bill", "jane", "mike"];
            var collection = array.ToAsyncEnumerable();
        ...
        public void When_collection_does_not_end_with_a_null_sequence_it_should_throw()
        {
            ...
            // Act
            Action act = () => collection.Should().EndWith((IAsyncEnumerable<string>)null);
        ...
        {
            // Arrange
            string[] array = ["john", "bill", "jane", null, "mike", null];
            var collection = array.ToAsyncEnumerable();
