...
public partial class AsyncEnumerableAssertionSpecs
{
    public class HaveElementPreceding
    {
        ...
        public void When_collection_has_the_correct_element_preceding_another_it_should_not_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().HaveElementPreceding("mick", "cris");
        ...
        public void When_collection_has_the_wrong_element_preceding_another_it_should_not_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().HaveElementPreceding("john", "cris", "because of some reason");
        ...
        public void When_nothing_is_preceding_an_element_it_should_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().HaveElementPreceding("cris", "jane");
        ...
        public void When_a_null_element_is_preceding_another_element_it_should_not_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().HaveElementPreceding("mick", null);
        ...
        public void When_an_element_is_preceding_a_null_element_it_should_not_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().HaveElementPreceding(null, "mick");
        ...
        public void When_an_element_is_not_preceding_a_null_element_it_should_throw()
        {
            ...
            // Act
            Action act = () => collection.ToAsyncEnumerable().Should().HaveElementPreceding(null, "cris");
