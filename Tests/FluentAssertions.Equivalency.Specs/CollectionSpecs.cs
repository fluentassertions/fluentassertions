...
namespace FluentAssertions.Equivalency.Specs
{
    public class CollectionSpecs
    {
        ...
        public class SubDummy
        {
            ...
            {
                return obj is SubDummy subDummy && Id == subDummy.Id;
            }
        ...
        public class UserRolesLookupElement
        {
            ...
            public virtual Dictionary<Guid, IEnumerable<string>> Roles
            {
                get
                {
                    return innerRoles.ToDictionary(x => x.Key, y => y.Value.Select(z => z));
                }
            }
...
#pragma warning restore CA1065
        ...
        public void When_the_expectation_has_fewer_dimensions_than_a_multi_dimensional_subject_it_should_fail()
        {
            ...
            // Assert
            act.Should().Throw<XunitException>().WithMessage("*be a collection with 2 item(s)*contains 1 item(s) less than*",
        ...
        public void When_collection_of_same_count_does_not_match_it_should_include_at_most_10_items_in_message()
        {
            ...
            var subject = new int[commonLength]
            {
                0,
                1,
                2,
            ...
            When_a_collection_contains_a_reference_to_an_object_that_is_also_in_its_parent_it_should_not_be_treated_as_a_cyclic_reference()
        {
            ...
            // Act
            Action act = () => logbookEntry.Should().BeEquivalentTo(equivalentLogbookEntry);
        ...
        public void When_a_collection_property_contains_objects_with_mismatching_properties_it_should_throw()
        {
            ...
            // Assert
            act.Should().Throw<XunitException>().WithMessage("*Customers[0].Name*John*Jane*");
        }
            ...
            When_a_object_implements_multiple_IEnumerable_interfaces_but_the_declared_type_is_assignable_to_only_one_and_runtime_checking_is_configured_it_should_fail()
        {
            ...
            // Act
            Action act = () => collection1.Should().BeEquivalentTo(collection2, opts => opts.RespectingRuntimeTypes());
        ...
        public void When_a_specific_property_is_included_it_should_ignore_the_rest_of_the_properties()
        {
            ...
            // Act
            Action act = () => result.Should().BeEquivalentTo(new[]
            {
                expected
            }, options => options.Including(x => x.A));
        ...
        {
            // Arrange
            ICollection collection1 = new List<Car>
            {
                new Car()
            };

            ICollection collection2 = new List<Customer>
            {
                new Customer()
            };
        ...
        public void When_more_than_10_strings_in_the_collection_are_not_equal_to_expected_string_only_10_are_reported()
        {
            ...
            action.Should().Throw<XunitException>().Which.Message.Should()
                .Contain("subject[9] to be \"one\", but \"two\" differs near \"two\" (index 0)").And.NotContain("subject[10]");
        }
        ...
        public void When_more_than_10_subjects_items_are_not_equivalent_to_expectation_only_10_are_reported()
        {
            ...
            // Assert
            action.Should().Throw<XunitException>().Which.Message.Should().Contain("subject[9] to be 1, but found 2").And
                .NotContain("item[10]");
        }
        ...
        public void When_an_unordered_collection_must_be_strict_using_a_predicate_it_should_throw()
        {
            ...
            // Act
            Action action = () => subject.Should().BeEquivalentTo(expectation,
                options => options.WithStrictOrderingFor(s => s.Path.Contains("UnorderedCollection")));
            ...
            When_an_unordered_collection_must_be_strict_using_a_predicate_and_order_was_reset_to_not_strict_it_should_not_throw()
        {
            ...
            // Act
            Action action = () => subject.Should().BeEquivalentTo(expectation,
                options => options.WithStrictOrderingFor(s => s.Path.Contains("UnorderedCollection")).WithoutStrictOrdering());
        ...
        public void When_an_unordered_collection_must_be_strict_using_an_expression_it_should_throw()
        {
            ...
            // Act
            Action action = () => subject.Should()
                .BeEquivalentTo(expectation, options => options.WithStrictOrderingFor(s => s.UnorderedCollection));
            ...
            When_an_unordered_collection_must_be_strict_using_an_expression_and_order_is_reset_to_not_strict_it_should_not_throw()
        {
            ...
            // Act
            Action action = () => subject.Should().BeEquivalentTo(expectation,
                options => options.WithStrictOrderingFor(s => s.UnorderedCollection).WithoutStrictOrdering());
        ...
        public void When_an_unordered_collection_must_not_be_strict_using_a_predicate_it_should_not_throw()
        {
            ...
            // Act
            Action action = () => subject.Should().BeEquivalentTo(expectation,
                options => options.WithStrictOrdering().WithoutStrictOrderingFor(s => s.Path.Contains("UnorderedCollection")));
        ...
        {
            // Arrange
            ICollection collection1 = new NonGenericCollection(new[]
            {
                new Customer()
            });

            ICollection collection2 = new NonGenericCollection(new[]
            {
                new Car()
            });
        ...
        {
            // Arrange
            var collection1 = new Collection<CustomerType>
            {
                new DerivedCustomerType("123")
            };

            var collection2 = new Collection<CustomerType>
            {
                new CustomerType("123")
            };
        ...
        {
            // Arrange
            ICollection subject = new NonGenericCollection(new[]
            {
                new Customer()
            });

            ICollection expectation = new NonGenericCollection(new[]
            {
                new Car()
            });
        ...
        public void When_custom_assertion_rules_are_utilized_the_rules_should_be_respected()
        {
            ...
            // Act
            Action act = () => subject.Should().BeEquivalentTo(expectation,
                opts => opts.Using<int>(ctx => ctx.Subject.Should().BeInRange(ctx.Expectation - 1, ctx.Expectation + 1))
                    .WhenTypeIs<int>());
        ...
        public void When_nested_objects_are_excluded_from_collections_it_should_use_simple_equality_semantics()
        {
            ...
            IList<MyObject> actualList = new List<MyObject>
            {
                actual
            };

            IList<MyObject> expectationList = new List<MyObject>
            {
                expectation
            };
        ...
        public void When_only_a_deeply_nested_property_is_included_it_should_exclude_the_other_properties()
        {
            ...
            // Act
            Action act = () => actualObjects.Should()
                .BeEquivalentTo(expectedObjects, options => options.Including(order => order.SubObject.Property1));
        ...
        public void When_not_all_string_subject_items_are_equal_to_expectation_object_with_a_config_it_should_fail()
        {
            ...
            // Assert
            action.Should().Throw<XunitException>().WithMessage("*we want to test the failure message*");
        }
        ...
        public void When_all_string_subject_items_are_equal_to_expectation_object_with_a_config_it_should_allow_chaining()
        {
            ...
            // Act
            Action action = () => subject.Should().AllBe("one", opt => opt).And.HaveCount(2);
        ...
        public void When_all_subject_items_are_equivalent_to_expectation_object_with_a_config_it_should_allow_chaining()
        {
            ...
            // Act
            Action action = () => subject.Should().AllBeEquivalentTo('g', opt => opt).And.HaveCount(2);
            ...
            When_the_root_object_is_referenced_from_an_object_in_a_nested_collection_it_should_treat_it_as_a_cyclic_reference()
        {
            ...
            company1.Users = new List<MyUser>
            {
                user1
            };
            ...
            company2.Users = new List<MyUser>
            {
                user2
            };
        ...
        public void When_the_subject_contains_same_number_of_items_but_expectation_contains_duplicates_it_should_throw()
        {
            ...
            // Assert
            action.Should().Throw<XunitException>()
                .WithMessage("Expected property subject[1].Name*to be \"John\", but \"Jane\" differs near*");
        }
        ...
        public void When_the_subject_contains_same_number_of_items_but_subject_contains_duplicates_it_should_throw()
        {
            ...
            // Assert
            action.Should().Throw<XunitException>()
                .WithMessage("Expected property subject[1].Name*to be \"Jane\", but \"John\" differs near*");
        }
        ...
        public void When_two_collections_have_properties_of_the_contained_items_excluded_but_still_differ_it_should_throw()
        {
            ...
            var list1 = new[]
            {
                new KeyValuePair<int, int>(1, 123)
            };

            var list2 = new[]
            {
                new KeyValuePair<int, int>(2, 321)
            };

            // Act
            Action act = () => list1.Should().BeEquivalentTo(list2,
                config => config.Excluding(ctx => ctx.Key).ComparingByMembers<KeyValuePair<int, int>>());
        ...
        public void When_two_lists_only_differ_in_excluded_properties_it_should_not_throw()
        {
            ...
            // Act
            Action action = () => subject.Should()
                .BeEquivalentTo(expectation, options => options.ExcludingMissingMembers().Excluding(c => c.Age));
        ...
        public void When_two_nested_dictionaries_contain_null_values_it_should_not_crash2()
        {
            ...
            // Assert
            act.Should().Throw<XunitException>().WithMessage("Expected*Roles[*][1]*Other*Special*");
        }
        ...
        public void When_two_nested_dictionaries_do_not_match_it_should_throw()
        {
            ...
            // Assert
            act.Should().Throw<XunitException>().WithMessage("Expected*ReferencedEquipment[1]*Bla1*Bla2*2*index 3*");
        }
        ...
        public void When_two_unordered_lists_are_structurally_equivalent_and_order_is_strict_it_should_fail()
        {
            ...
            // Assert
            action.Should().Throw<XunitException>()
                .WithMessage("Expected property subject[0].Name*Jane*John*subject[1].Name*John*Jane*");
        }
        ...
        public void When_two_unordered_lists_are_structurally_equivalent_and_order_was_reset_to_strict_it_should_fail()
        {
            ...
            // Act
            Action action = () => subject.Should().BeEquivalentTo(expectation,
                options => options.WithStrictOrdering().WithoutStrictOrdering().WithStrictOrdering());
        ...
        {
            // Arrange
            var genericCollectionA = new List<ExceptionThrowingClass>()
            {
                new ExceptionThrowingClass()
            };

            var genericCollectionB = new List<ExceptionThrowingClass>()
            {
                new ExceptionThrowingClass()
            };
