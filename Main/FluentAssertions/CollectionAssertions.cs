...
namespace FluentAssertions
{
    public class CollectionAssertions : Assertions<IEnumerable, CollectionAssertions>
    {
        ...
        public AndConstraint<CollectionAssertions> HaveCount(int expected, string reason,
        ...
        public AndConstraint<CollectionAssertions> ContainItemsAssignableTo<T>(string reason,
                                                                               params object[] reasonParameters)
        {
            int index = 0;
        ...
        /// <param name="expected"/>. Elements are compared using their <see cref="object.Equals(object)"/>.
        /// </summary>
        public AndConstraint<CollectionAssertions> Equal(IEnumerable expected, string reason,
                                                         params object[] reasonParameters)
        {
                                                            ...
                                                            params object[] reasonParameters)
        {
            ...
            {
                FailWith("Did not expect collections {0} and {1} to be equal{2}.", expected, ActualValue, reason,
                         reasonParameters);
            }
                                                                     ...
                                                                     params object[] reasonParameters)
        {
            ...
            {
                FailWith("Expected collection {1} not be equivalent with collection {0}.", expected, ActualValue, reason,
                         reasonParameters);
            }
        ...
        public AndConstraint<CollectionAssertions> Contain(object expected, string reason,
                                                           params object[] reasonParameters)
        {
        ...
        /// using their <see cref="object.Equals(object)"/> implementation.
        /// </summary>
        public AndConstraint<CollectionAssertions> Contain(IEnumerable expected, string reason,
                                                           params object[] reasonParameters)
        {
            if (expected == null)
            {
            ...
            {
                if (!ActualValue.Cast<object>().Contains(expected))
                {
                    FailWith("Expected collection {1} to contain {0}{2}.", expected, ActualValue, reason, reasonParameters);
                }
            }
            else
            {
        ...
        public AndConstraint<CollectionAssertions> NotContain(object unexpected, string reason,
                                                              params object[] reasonParameters)
        {
        ...
        /// using their <see cref="object.Equals(object)"/> implementation.
        /// </summary>
        public AndConstraint<CollectionAssertions> ContainInOrder(IEnumerable expected, string reason,
                                                                  params object[] reasonParameters)
        {
            if (expected == null)
            {
        ...
        /// Assert that the current collection has the same number of elements as <paramref name="otherCollection"/>.
        /// </summary>
        public AndConstraint<CollectionAssertions> HaveSameCount(IEnumerable otherCollection, string reason,
                                                                 params object[] reasonParameters)
        {
            IEnumerable<object> enumerable = ActualValue.Cast<object>();
        ...
        public AndConstraint<CollectionAssertions> BeNull(string reason, params object[] reasonParameters)
        {
            ...
            {
                FailWith("Expected collection to be <null>{2}, but found {1}.", null, ActualValue, reason,
                         reasonParameters);
            }
