...
namespace FluentAssertions.Specs
{
   ...
   public class DateTimeAssertionSpecs
   {
      ...
      public void When_datetime_is_less_then_and_not_close_to_another_value_it_should_throw()
      {
         ...
         //-----------------------------------------------------------------------------------------------------------
         act.ShouldThrow<AssertFailedException>()
            .WithMessage("Expected datetime to be within 20 ms from <2012-03-13 12:15:31>, but found <2012-03-13 12:15:30.979>.");
      }
      ...
      public void When_datetime_is_greater_then_and_not_close_to_another_value_it_should_throw()
      {
         ...
         //-----------------------------------------------------------------------------------------------------------
         act.ShouldThrow<AssertFailedException>()
            .WithMessage("Expected datetime to be within 20 ms from <2012-03-13 12:15:31>, but found <2012-03-13 12:15:31.021>.");
      }
