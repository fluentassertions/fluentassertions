...
namespace FluentAssertions.EventMonitoring
{
    ...
    public static class EventMonitoringExtensions
    {
        ...
        public static IEnumerable<EventRecorder> MonitorEvents(this INotifyPropertyChanged eventSource)
        {
            ...
            var recorders = new[] {CreateEventHandler(eventSource)};
        ...
        private static EventRecorder CreateEventHandler(INotifyPropertyChanged eventSource)
        {
        ...
        /// </remarks>
        internal static EventRecorder ShouldRaise(
        ...
        {
            return 
                ShouldRaise(eventSource, "PropertyChanged", reason, reasonParameters)
                .WithArgs<PropertyChangedEventArgs>(args => args.PropertyName == propertyExpression.GetPropertyInfo().Name);
        }
        ...
        /// </summary>
        internal static IEventRecorder WithArgs<T>(this IEventRecorder eventRecorder, Expression<Func<T, bool>> predicate) where T : EventArgs
        {
