...
namespace FluentAssertions
{
    public class DoubleAssertions : NumericAssertions<double>
    {
        ...
        /// </param>
        public AndConstraint<DoubleAssertions> BeApproximately(double expectedValue, double precision, string reason,
            params object[] reasonArgs)
        {
            double actualDifference = Math.Abs(expectedValue - Subject.Value);
