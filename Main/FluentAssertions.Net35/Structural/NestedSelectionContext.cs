...
namespace FluentAssertions.Structural
{
    ...
    /// </summary>
    internal class NestedSelectionContext : ISelectionContext
    {
        public NestedSelectionContext(ISelectionContext context, PropertyInfo propertyInfo)
        {
        ...
        /// <summary>
        /// Gets a textual description of the current property based on the <see cref="ISelectionContext.PropertyPath"/>.
        /// </summary>
