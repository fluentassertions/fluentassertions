...
namespace FluentAssertions.Primitives
{
    ...
    public class NullableBooleanAssertions : BooleanAssertions
    {
        ...
        /// Zero or more objects to format using the placeholders in <see cref="reason" />.
        /// </param>
        public AndConstraint<BooleanAssertions> NotBeFalse(string reason = "", params object[] reasonArgs)
        {
            Execute.Assertion
        ...
        /// Zero or more objects to format using the placeholders in <see cref="reason" />.
        /// </param>
        public AndConstraint<BooleanAssertions> NotBeTrue(string reason = "", params object[] reasonArgs)
        {
            Execute.Assertion
                .ForCondition(!Subject.HasValue || !Subject.Value)
                .BecauseOf(reason, reasonArgs)
