...
theString.Should().Contain("is a", Exactly.Times(5));
...
theString.Should().Contain("is a", AtLeast.Times(5));
...
theString.Should().Contain("is a", MoreThan.Times(5));
...
theString.Should().Contain("is a", LessThan.Times(5));
...
theString.Should().ContainEquivalentOf("WE DONT CARE ABOUT THE CASING", Exactly.Times(5));
...
theString.Should().ContainEquivalentOf("WE DONT CARE ABOUT THE CASING", AtLeast.Times(5));
...
theString.Should().ContainEquivalentOf("WE DONT CARE ABOUT THE CASING", MoreThan.Times(5));
...
theString.Should().ContainEquivalentOf("WE DONT CARE ABOUT THE CASING", LessThan.Times(5));
