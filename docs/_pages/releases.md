...
**What's New**
* Added official support for .NET Core 3.1
...
**Breaking Changes**
* Dropped support for .NET Framework 4.5, .NET Core 2.0 and 3.0, .NET Standard 1.3 and 1.6 - [#1227](https://github.com/fluentassertions/fluentassertions/pull/1227)
