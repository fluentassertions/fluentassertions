...
* Added new extension methods to be able to write `Exactly.Times(n)`, `AtLeast.Times(n)` and `AtMost.Times(n)` in way that reads less odd and bumpy  - [#2047](https://github.com/fluentassertions/fluentassertions/pull/2047)
