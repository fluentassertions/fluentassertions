...
* Added `HaveMillisecond` and `NotHaveMillisecond` for assertions on `DateTime` and `DateTimeOffset` - [#2775](https://github.com/fluentassertions/fluentassertions/pull/2775)
