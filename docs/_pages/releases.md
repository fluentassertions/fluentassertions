...
* Added `Excluding<T>()` and `Excluding(Type)` overloads to exclude all members of a certain type from equivalency comparisons - [#3114](https://github.com/fluentassertions/fluentassertions/pull/3114)
