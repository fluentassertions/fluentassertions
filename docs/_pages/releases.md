...
* Added `ThenExcluding` option to `BeEquivalentTo` to exclude members in nested collections - [#1771](https://github.com/fluentassertions/fluentassertions/pull/1771)
