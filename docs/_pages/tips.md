...
The examples below show how you might write equivalent xUnit assertions using Fluent Assertions including the failure message from each case.
We think this is both a useful migration guide and a convincing argument for switching.

If you see something missing, please consider submitting a pull request.

{% include assertion-comparison.html header1="xUnit" header2="Fluent Assertions" idPrefix="xunit-" caption="Assert" examples=site.data.xunit-migration.assert %}
