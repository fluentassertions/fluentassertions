...
namespace FluentAssertions
{
    ...
    public static partial class AssertionExtensions
    {
        ...
        {
            return new AsyncActionAssertions(action.ExecuteInDefaultSynchronizationContext, extractor);
        }
        ...
        {
            return new AsyncFunctionAssertions<T>(action.ExecuteInDefaultSynchronizationContext, extractor);
        }
