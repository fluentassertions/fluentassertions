...
internal class StringEqualityStrategy : IStringComparisonStrategy
{
    ...
    private void ValidateAgainstSuperfluousWhitespace(AssertionChain assertionChain, string subject, string expected)
    {
        assertionChain
    ...
    private bool ValidateAgainstLengthDifferences(AssertionChain assertionChain, string subject, string expected)
    {
        assertionChain
