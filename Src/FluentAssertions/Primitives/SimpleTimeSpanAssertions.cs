        ...
        where TAssertions : SimpleTimeSpanAssertions<TAssertions>
    {
        ...
        public AndConstraint<TAssertions> BePositive(string because = "", params object[] becauseArgs)
        {
            Execute.Assertion.BecauseOf(because, becauseArgs)
                ...
                .Then.ForCondition(Subject.Value.CompareTo(TimeSpan.Zero) > 0)
        ...
        public AndConstraint<TAssertions> Be(TimeSpan expected, string because = "", params object[] becauseArgs)
        {
            Execute.Assertion.BecauseOf(because, becauseArgs)
                ...
                .ForCondition(Subject.HasValue)
                .FailWith("but found <null>.")
                .Then.ForCondition(Subject.Value.CompareTo(expected) == 0)
                .FailWith("but found {0}.", Subject.Value)
                .Then.ClearExpectation();
            ...
            params object[] becauseArgs)
        {
            ...
            Execute.Assertion.ForCondition(Subject >= minimumValue && Subject.Value <= maximumValue)
                .BecauseOf(because, becauseArgs)
                .FailWith("Expected {context:time} to be within {0} from {1}{reason}, but found {2}.", precision, nearbyTime,
                    Subject);
            ...
            params object[] becauseArgs)
        {
            ...
            Execute.Assertion.ForCondition(Subject < minimumValue || Subject > maximumValue)
                .BecauseOf(because, becauseArgs)
                .FailWith("Expected {context:time} to not be within {0} from {1}{reason}, but found {2}.", precision, distantTime,
                    Subject);
