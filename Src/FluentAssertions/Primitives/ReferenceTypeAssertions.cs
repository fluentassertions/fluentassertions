        ...
        where TAssertions : ReferenceTypeAssertions<TSubject, TAssertions>
    {
        ...
        public AndConstraint<TAssertions> BeNull(string because = "", params object[] becauseArgs)
        {
            Execute.Assertion
                ...
                .FailWith(Resources.RefType_ExpectedContextToBeNullButFoundX0Format, Subject);
        ...
        public AndConstraint<TAssertions> BeSameAs(TSubject expected, string because = "", params object[] becauseArgs)
        {
            Execute.Assertion
                ...
                .BecauseOf(because, becauseArgs)
                .WithDefaultIdentifier(Identifier)
                .FailWith(Resources.RefType_ExpectedContextToReferToX0Format + Resources.Common_CommaButFoundX1Format, expected, Subject);
        ...
        public AndConstraint<TAssertions> NotBeSameAs(TSubject unexpected, string because = "", params object[] becauseArgs)
        {
            Execute.Assertion
                ...
                .BecauseOf(because, becauseArgs)
                .WithDefaultIdentifier(Identifier)
                .FailWith(Resources.Object_DidNotExpectContextToReferToX0Format, unexpected);
        ...
        public AndConstraint<TAssertions> BeOfType(Type expectedType, string because = "", params object[] becauseArgs)
        {
            Execute.Assertion
                ...
                .FailWith(Resources.RefType_ExpectedContextToBeX0Format + Resources.Common_CommaButFoundNull, expectedType);
        ...
        public AndConstraint<TAssertions> NotBeOfType(Type unexpectedType, string because = "", params object[] becauseArgs)
        {
            Execute.Assertion
                ...
                .BecauseOf(because, becauseArgs)
                .WithDefaultIdentifier("type")
                .FailWith(Resources.RefType_ExpectedContextNotToBeX0Format + Resources.Common_CommaButFoundNull, unexpectedType);
        ...
        public AndWhichConstraint<TAssertions, T> BeAssignableTo<T>(string because = "", params object[] becauseArgs)
        {
            Execute.Assertion
                ...
                .BecauseOf(because, becauseArgs)
                .WithDefaultIdentifier(Identifier)
                .FailWith(Resources.RefType_ExpectedContextToBeAssignableToX0ButX1IsNotFormat,
                    typeof(T),
                    Subject.GetType());
        ...
        public AndConstraint<TAssertions> BeAssignableTo(Type type, string because = "", params object[] becauseArgs)
        {
            Execute.Assertion
                ...
                .BecauseOf(because, becauseArgs)
                .WithDefaultIdentifier("type")
                .FailWith(Resources.RefType_ExpectedContextNotToBeX0Format + Resources.Common_CommaButFoundNull, type);
        ...
        public AndConstraint<TAssertions> NotBeAssignableTo(Type type, string because = "", params object[] becauseArgs)
        {
            ...
            Execute.Assertion
                ...
                .BecauseOf(because, becauseArgs)
                .WithDefaultIdentifier(Identifier)
                .FailWith(Resources.RefType_ExpectedContextToNotBeAssignableX0ToButX1IsFormat,
                    type,
                    Subject.GetType());
            ...
            where T : TSubject
        {
            ...
            Execute.Assertion
                ...
                .BecauseOf(because, becauseArgs)
                .WithDefaultIdentifier(Identifier)
                .FailWith(Resources.RefType_ExpectedObjectToMatchY + Resources.Common_CommaButFoundX0Format, Subject, predicate.Body);
