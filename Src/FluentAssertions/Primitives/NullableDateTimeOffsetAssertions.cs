    ...
    public class NullableDateTimeOffsetAssertions : DateTimeOffsetAssertions
    {
        ...
        public AndConstraint<NullableDateTimeOffsetAssertions> HaveValue(string because = "", params object[] becauseArgs)
        {
            Execute.Assertion
                ...
                .FailWith(Resources.DateTime_ExpectedVariableToHaveAValue + Resources.Common_CommaButFoundX0Format,
                    Subject);
            ...
            params object[] becauseArgs)
        {
            Execute.Assertion
                .ForCondition(!Subject.HasValue)
                .BecauseOf(because, becauseArgs)
                .FailWith(Resources.DateTime_DidNotExpectVariableToHaveAValue + Resources.Common_CommaButFoundX0Format,
                    Subject);
