...
public class PropertyInfoAssertions : MemberInfoAssertions<PropertyInfo, PropertyInfoAssertions>
{
        ...
        params object[] becauseArgs)
    {
        ...
        assertionChain
            ...
            .ForCondition(!Subject.IsVirtual())
            .BecauseOf(because, becauseArgs)
            .FailWith($"Expected property {subjectDescription} not to be virtual{{reason}}, but it is.");
        ...
        [StringSyntax("CompositeFormat")] string because = "", params object[] becauseArgs)
    {
        ...
        assertionChain
            ...
            .BecauseOf(because, becauseArgs)
            .FailWith(
                $"Expected {subjectDescription} to have a setter{{reason}}.",
                Subject);
        ...
        [StringSyntax("CompositeFormat")] string because = "", params object[] becauseArgs)
    {
        ...
        assertionChain
            ...
            .ForCondition(!Subject!.CanWrite)
            .BecauseOf(because, becauseArgs)
            .FailWith($"Did not expect {subjectDescription} to have a setter{{reason}}.");
        ...
        [StringSyntax("CompositeFormat")] string because = "", params object[] becauseArgs)
    {
        ...
        if (assertionChain.Succeeded)
        {
            ...
            assertionChain
                ...
                .BecauseOf(because, becauseArgs)
                .FailWith(
                    $"Did not expect {subjectDescription} to have a getter{{reason}}.", Subject);
        }
