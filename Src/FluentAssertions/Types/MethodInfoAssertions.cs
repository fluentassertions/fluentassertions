...
namespace FluentAssertions.Types
{
    ...
    public class MethodInfoAssertions : MethodBaseAssertions<MethodInfo, MethodInfoAssertions>
    {
        ...
        public AndConstraint<MethodInfoAssertions> BeVirtual(string because = "", params object[] becauseArgs)
        {
            ...
            if (success)
            {
                Execute.Assertion.ForCondition(!Subject.IsNonVirtual())
        ...
        public AndConstraint<MethodInfoAssertions> BeAsync(string because = "", params object[] becauseArgs)
        {
            ...
            if (success)
            {
                Execute.Assertion.ForCondition(Subject.IsAsync())
                    .BecauseOf(because, becauseArgs)
            ...
            string because = "", params object[] becauseArgs)
        {
            ...
            bool success = Execute.Assertion.BecauseOf(because, becauseArgs)
                .ForCondition(Subject is not null)
                .FailWith("Expected the return type of method not to be {0}{reason}, but {context:member} is <null>.",
                    returnType);
            ...
            if (success)
            {
                Execute.Assertion.ForCondition(returnType != Subject.ReturnType)
                    .BecauseOf(because, becauseArgs)
                    .FailWith("Expected the return type of method " + Subject.Name + " not to be {0}{reason}, but it is.",
                        returnType);
            }
