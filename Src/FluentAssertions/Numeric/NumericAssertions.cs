...
#pragma warning disable CA1065 // Ignore throwing NotSupportedException from Equals
        ...
        where TAssertions : NumericAssertions<T, TAssertions>
    {
        ...
        public AndConstraint<TAssertions> Be(T? expected, string because = "", params object[] becauseArgs)
        {
            Execute.Assertion.ForCondition((!Subject.HasValue && !expected.HasValue) ||
        ...
        {
            Execute.Assertion.ForCondition(!Subject.HasValue || Subject.Value.CompareTo(unexpected) != 0)
                .BecauseOf(because, becauseArgs)
        ...
        public AndConstraint<TAssertions> NotBe(T? unexpected, string because = "", params object[] becauseArgs)
        {
            Execute.Assertion.ForCondition(!Subject.HasValue == unexpected.HasValue ||
        ...
        {
            Execute.Assertion.ForCondition(Subject.HasValue && Subject.Value.CompareTo(default) > 0)
                .BecauseOf(because, becauseArgs)
        ...
        {
            return BeLessThanOrEqualTo(expected, because, becauseArgs);
        }
        ...
        public AndConstraint<TAssertions> BeGreaterThanOrEqualTo(T expected, string because = "", params object[] becauseArgs)
        {
            Execute.Assertion.ForCondition(Subject.HasValue && Subject.Value.CompareTo(expected) >= 0)
                .BecauseOf(because, becauseArgs)
                .FailWith("Expected {context:value} to be greater than or equal to {0}{reason}, but found {1}.", expected,
                    Subject);
        ...
        {
            return BeGreaterThanOrEqualTo(expected, because, becauseArgs);
        }
        ...
        {
            Execute.Assertion.ForCondition(Subject.HasValue && Subject.Value.CompareTo(minimumValue) >= 0 &&
                    Subject.Value.CompareTo(maximumValue) <= 0)
                .BecauseOf(because, becauseArgs)
                .FailWith("Expected {context:value} to be between {0} and {1}{reason}, but found {2}.", minimumValue,
                    maximumValue, Subject);
            ...
            params object[] becauseArgs)
        {
            Execute.Assertion.ForCondition(Subject.HasValue &&
                    !(Subject.Value.CompareTo(minimumValue) >= 0 && Subject.Value.CompareTo(maximumValue) <= 0))
                .BecauseOf(because, becauseArgs)
                .FailWith("Expected {context:value} to not be between {0} and {1}{reason}, but found {2}.", minimumValue,
                    maximumValue, Subject);
        ...
        /// Zero or more objects to format using the placeholders in <paramref name="because" />.
        /// </param>
        public AndConstraint<TAssertions> BeOneOf(IEnumerable<T> validValues, string because = "", params object[] becauseArgs)
        {
            Execute.Assertion.ForCondition(Subject.HasValue && validValues.Contains((T)Subject))
                .BecauseOf(because, becauseArgs)
        ...
        public AndConstraint<TAssertions> BeOfType(Type expectedType, string because = "", params object[] becauseArgs)
        {
            ...
            {
                (subjectType?.GetGenericTypeDefinition()).Should()
