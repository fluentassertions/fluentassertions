...
internal class Property : Node, IMember
{
    ...
    public Property(Type reflectedType, PropertyInfo propertyInfo, INode parent)
    {
        ...
        Subject = new Pathway(parent.Subject.PathAndName, propertyInfo.Name,  () => $"property {parent.GetSubjectId()}.");
        Expectation = new Pathway(parent.Expectation.PathAndName, propertyInfo.Name, () => "property ");
