...
internal class MultiDimensionalArrayEquivalencyStep : IEquivalencyStep
{
        ...
        IValidateChildNodeEquivalency nestedValidator)
    {
        ...
        if (AreComparable(comparands, expectationAsArray, assertionChain))
        {
            ...
            do
            {
                ...
                nestedValidator.AssertEquivalencyOf(new Comparands(subject, expectation, typeof(object)), assertionChain,
                    itemContext);
            }
