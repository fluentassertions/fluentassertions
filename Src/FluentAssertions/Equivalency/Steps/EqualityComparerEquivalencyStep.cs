...
namespace FluentAssertions.Equivalency.Steps
{
    public class EqualityComparerEquivalencyStep<T> : IEquivalencyStep
    {
            ...
            IEquivalencyValidator nestedValidator)
        {
            ...
            Execute.Assertion.BecauseOf(context.Reason.FormattedMessage, context.Reason.Arguments)
                ...
                .Then.Given(() => comparer.Equals((T)comparands.Subject, (T)comparands.Expectation))
