...
namespace FluentAssertions.Equivalency.Steps
{
    public class DictionaryEquivalencyStep : EquivalencyStep<IDictionary>
    {
                    ...
                    foreach (object key in expectation.Keys)
                    {
                        if (context.Options.IsRecursive)
                        {
                            ...
                            nestedValidator.RecursivelyAssertEquality(
                                new Comparands(subject[key], expectation[key], typeof(object)),
        ...
        {
            return AssertIsDictionary(subject) && AssertEitherIsNotNull(expectation, subject) &&
        ...
        {
            return AssertionScope.Current.ForCondition((expectation is null && subject is null) || expectation is not null)
        ...
        {
            return AssertionScope.Current.ForCondition(expectation is null || subject.Keys.Count == expectation.Keys.Count)
