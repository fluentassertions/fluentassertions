...
internal class Field : Node, IMember
{
    ...
    public Field(FieldInfo fieldInfo, INode parent)
    {
        ...
        Subject = new Pathway(parent.Subject.PathAndName, fieldInfo.Name, () => $"field {GetSubjectId()}");
        Expectation = new Pathway(parent.Expectation.PathAndName, fieldInfo.Name, () => "field");
