...
public class EquivalencyPlan : IEnumerable<IEquivalencyStep>
{
    ...
    /// </summary>
    /// <remarks>
    /// This method is not thread-safe and should not be invoked on <see cref="AssertionConfiguration.EquivalencyPlan"/> from within a unit test.
    ...
    /// </summary>
    /// <remarks>
    /// This method should not be invoked on <see cref="AssertionConfiguration.EquivalencyPlan"/> from within a unit test.
    /// See the <see href="https://fluentassertions.com/extensibility/#thread-safety">docs</see> on how to safely use it.
    /// </remarks>
    public void Reset()
    {
