...
public sealed class AssertionChain
{
    ...
    private bool previousAssertionSucceeded = true;
    ...
    private Continuation FailWith(Func<string> failReasonFunc)
    {
        if (previousAssertionSucceeded)
        {
            ...
            if (!previousAssertionSucceeded)
            {
                ...
                getCurrentScope().AddPreFormattedFailure(result.Capitalize().RemoveTrailingWhitespaceFromLines());
            }
        }
    ...
    public bool PreviousAssertionSucceeded => previousAssertionSucceeded;
    ...
    public AssertionChain ClearExpectation()
    {
        // expectation = null;
        return this;
    }
