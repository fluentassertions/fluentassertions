...
namespace FluentAssertions.Collections
{
        ...
        ReferenceTypeAssertions<IReadOnlyDictionary<TKey, TValue>, GenericReadOnlyDictionaryAssertions<TKey, TValue>>
    {
        ...
        /// Zero or more objects to format using the placeholders in <see cref="because" />.
        /// </param>
        public AndConstraint<GenericReadOnlyDictionaryAssertions<TKey, TValue>> Equal(IReadOnlyDictionary<TKey, TValue> expected,
            string because = "", params object[] becauseArgs)
        {
            if (Subject is null)
            {
        ...
        /// Zero or more objects to format using the placeholders in <see cref="because" />.
        /// </param>
        public AndConstraint<GenericReadOnlyDictionaryAssertions<TKey, TValue>> NotEqual(IReadOnlyDictionary<TKey, TValue> unexpected,
            string because = "", params object[] becauseArgs)
        {
            if (Subject is null)
            {
        ...
        /// Zero or more objects to format using the placeholders in <see cref="because" />.
        /// </param>
        public WhichReadOnlyValueConstraint<TKey, TValue> ContainKey(TKey expected,
            string because = "", params object[] becauseArgs)
        {
            ...
            return new WhichReadOnlyValueConstraint<TKey, TValue>(andConstraint.And, value);
        }
