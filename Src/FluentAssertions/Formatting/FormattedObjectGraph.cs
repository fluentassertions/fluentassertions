...
public class FormattedObjectGraph
{
    ...
    internal void InsertLineBefore(Line line, string content)
    {
        lines.InsertLineBefore(line, new Line(content));
    }

    internal void InsertAtTop(string fragment)
    {
        lines.InsertAtTop(fragment);
    }
