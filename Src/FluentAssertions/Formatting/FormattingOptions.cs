...
{
    internal static readonly List<IValueFormatter> CustomFormatters = [];

    internal List<IValueFormatter> ScopedFormatters { get; } = [];
    ...
    internal static void RemoveCustomFormatter(IValueFormatter formatter)
    {
        CustomFormatters.Remove(formatter);
    }

    internal static void AddCustomFormatter(IValueFormatter formatter)
    {
